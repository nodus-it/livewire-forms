...
enum Currency: string
{
    ...
    case Bond_Markets_Unit_European_Monetary_Unit_EMU_6 = 'XBB';
    case Bond_Markets_Unit_European_Unit_of_Account_17_EUA_17 = 'XBD';
    case Bond_Markets_Unit_European_Unit_of_Account_9_EUA_9 = 'XBC';
